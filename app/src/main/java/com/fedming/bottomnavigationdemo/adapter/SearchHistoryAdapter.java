...
public class SearchHistoryAdapter extends RecyclerView.Adapter<SearchHistoryAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyViewHolder holder = new MyViewHolder(LayoutInflater.from(context).
                inflate(com.wyt.searchbox.R.layout.item_search_history, parent, false));
        return holder;
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            historyInfo = (TextView) view.findViewById(com.wyt.searchbox.R.id.tv_item_search_history);
            delete = (ImageView) view.findViewById(com.wyt.searchbox.R.id.iv_item_search_delete);
        }
    }
