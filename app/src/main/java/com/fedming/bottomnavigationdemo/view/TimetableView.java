...
public class TimetableView extends ViewGroup {
    ...
    private static final int MAX_SECTION = 10; //一天 10节课
        ...
        for (int i = 0; i < courses.size(); i++) {
            ...
            tvItem.setOnLongClickListener(new OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (mListener != null) {
//                        调用实现的方法！
                        mListener.onLongCourseItemClick(course);
                    }
                    return true;
                }
            });
...
//                        调用实现的方法！
    ...
    public interface OnCourseItemClickListener {
        ...
        void onLongCourseItemClick(CourseModel course);
    }
    ...
    public class OnCourseItemClickListenerImp implements OnCourseItemClickListener {
        ...
        public void onCourseItemClick(CourseModel course) {
            new SuperDialog.Builder((FragmentActivity) context).setRadius(30)
                    .setAlpha(1f)
                    .setTitle(course.getCname()).setMessage(course.toString())
        ...
        @Override
        public void onLongCourseItemClick(CourseModel course) {
            Toast.makeText(context, "测试长按功能成功", Toast.LENGTH_SHORT).show();
        }
